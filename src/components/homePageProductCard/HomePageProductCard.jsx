...
const HomePageProductCard = () => {
    ...
    return (
        <div className="mt-10 bg-black text-white">
            {/* Heading  */}
            <div className="">
                <h1 className="text-center mb-5 text-2xl font-semibold text-gray-100">Bestselling Products</h1>
            </div>
                        ...
                        {getAllProduct.slice(0, 8).map((item, index) => {
                            ...
                            return (
                                <div key={index} className="p-4 w-full md:w-1/4">
                                    <div className="h-full border border-gray-700 rounded-xl overflow-hidden shadow-lg cursor-pointer bg-gray-900">
                                        <img
