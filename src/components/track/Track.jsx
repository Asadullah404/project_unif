            ...
            <div className="container mx-auto px-5 py-10 md:py-14">
                ...
                <div className="flex flex-wrap -m-4 text-center">
                    ...
                    <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                        <div className="border-2 hover:shadow-xl hover:border-transparent border-gray-700 bg-gray-800 shadow-md px-4 py-6 rounded-lg" >
                            ...
                            <h2 className="title-font font-medium text-lg">Premium Tshirts</h2>
